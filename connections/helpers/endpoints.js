...
export const PAGO_POST_ENDPOINT= API_URL+"/registrarPago";
export const EXTRAC_POST_ENDPOINT= API_URL+"/generarExtracto";
export const CARTE_POST_ENDPOINT= API_URL+"/reporteCartera";
